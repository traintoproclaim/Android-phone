...
public class Screen17_3_major_events extends BaseActivity implements OnClickListener {

	private RelativeLayout rl;
	private ImageView iv_event_line,iv_cross,iv_event_text,iv_soul_transfer;
	...
	public void onClick(View v) {
		if(v == rl){
			...
			*/
			case 6:
				startActivity( new Intent(this, Screen17_3_2_major_events.class));
				finish();
				break;
			}
		}
	...
	public void onBackPressed() {
		super.onBackPressed();
		Intent i = new Intent(this,Screen16_soul_transfer.class);
		startActivity(i);
		finish();
	}
