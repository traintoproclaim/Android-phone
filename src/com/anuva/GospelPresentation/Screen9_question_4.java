...
public class Screen9_question_4 extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iv_text_top.setBackgroundResource(R.drawable.disrespected_gods_name);
        ...
        iv_text_bottom.setBackgroundResource(R.drawable.blasphemers);
        ...
        tv_bottom.setText("Have you ever used God’s or Jesus’ Name in a disrespectful way?");
	...
	public void onClick(View v) {
		...
		if(v==ib_yes){
			prefsEditor.putString("is_blasphemy", "yes");
		    prefsEditor.commit();
			...
			iv_text_bottom.setBackgroundResource(R.drawable.blasphemers);
			iv_text_bottom.setVisibility(View.VISIBLE);
			tv_bottom.setText("This is called BLASPHEMY.");
				...
				public void onClick(View v) {
					if(rl_click==0){
						...
						rl_click++;
						 ...
						 Intent i = new Intent(Screen9_question_4.this,Screen10_list_of_guilty.class);
						 startActivity(i);
						 finish();
					}
				}
			...
			prefsEditor.putString("is_blasphemy", "no");
		    prefsEditor.commit();
			rl.setClickable(true);
			
			Intent i = new Intent(Screen9_question_4.this,Screen9_question_5.class);
			startActivity(i);
			finish();
